...
export const verticalMenuItems = [ 
    ...
    new Menu (430, '모니터링', null, null, 'pets', null, true, 0),
    new Menu (431, '운영서버 메트릭', '/pulsar/metric/os', null, 'airplay', null, false, 430),
    ...
    new Menu (330, '샘플', null, null, 'more_horiz', null, true, 0),
    new Menu (331, '팀', '/pulsar/team', null, 'team', null, false, 330),
    new Menu (332, '유저', '/pulsar/user', null, 'user', null, false, 330),
    new Menu (333, 'agent', '/pulsar/agent', null, 'agent', null, false, 330),
    new Menu (334, '스케줄', '/pulsar/schedule', null, 'schedule', null, false, 330),
]
